  ...
  const services = [
    {
      ...
      description: 'Build AI workflows, chatbots, voice agents, and autonomous systems. Automate tasks from HR processes to customer support.',
      features: ['Chatbots & Voice Agents', 'Workflow Automation', 'Decision-Making Systems'],
      color: 'from-cyan-400 to-blue-500',
    },
    {
      icon: Brain,
      title: 'AI Product Development',
      description: 'End-to-end AI product creation from ideation to deployment. NLP, Computer Vision, and multi-modal AI systems.',
      features: ['NLP & Computer Vision', 'Model Design & Training', 'Production Deployment'],
      color: 'from-purple-400 to-pink-500',
    },
    {
      icon: Code,
      title: 'Full-Stack Web Development',
      description: 'Modern web applications with React, Next.js, NestJS, FastAPI. Seamless AI integration into user experiences.',
      features: ['React & Next.js', 'Backend APIs', 'Real-time Systems'],
    ...
    {
      icon: Workflow,
      title: 'MVPs & Enterprise Applications',
      description: 'From proof-of-concept to full-scale deployment. Scalable architecture for startups and enterprises.',
      features: ['MVP Development', 'Enterprise Solutions', 'Scalable Architecture'],
      color: 'from-indigo-400 to-purple-500',
    },
    {
      icon: Rocket,
      title: 'AI Consulting & Strategy',
      description: 'Strategic guidance for AI adoption. Feasibility analysis, architecture consulting, and roadmap development.',
      features: ['AI Strategy', 'Feasibility Analysis', 'Technical Roadmaps'],
