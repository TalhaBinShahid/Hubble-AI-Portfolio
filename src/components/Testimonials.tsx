  ...
  const testimonials = [
    {
      ...
      content: 'RyzenAI transformed our recruitment process with HRXpert. We reduced time-to-hire by 60% and improved candidate quality significantly. Their team understood our needs perfectly and delivered beyond expectations.',
    ...
    },
    {
      ...
      content: 'VizdomAI revolutionized our quality control process. The computer vision system catches defects with incredible accuracy. RyzenAI\'s expertise in AI and production deployment made the transition seamless.',
    ...
    },
    {
      ...
      company: 'AI Startup',
      content: 'Working with RyzenAI was a game-changer for our startup. They took our idea and built a production-ready AI platform in record time. The quality of code and architecture is exceptional.',
    ...
    },
    {
      ...
      content: 'RyzenAI delivered a sophisticated document processing system that handles thousands of documents daily with impressive accuracy. Their understanding of both AI and enterprise needs is outstanding.',
